 ...
 */
export const toastException = (error: Error | { response?: { data?: { message?: string }, statusText?: string }, data?: { message?: string }, message?: string } | string, title: string = '操作失败') => {
 ...
 */
export const toast = (options: Partial<SweetAlertOptions>) => {
  return Swal.fire({
    ...defaultToastConfig,
    ...options
